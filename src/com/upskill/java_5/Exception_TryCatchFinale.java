...
*/
	...
	public static void main(String[] args) {
		...
		//Built-in Exceptions- ArrayIndexOutOfBoundsException -  an array has been accessed with an illegal index.
	try{
		int[] ageIronMan = new int[] {23, 24, 32};
		System.out.println("My IT Iron man team lead age is : " + ageIronMan[2]);
		System.out.println("My IT Iron man team average age length : " + ageIronMan.length);
	...
	//Built-in Exceptions-  NumberFormatException  -  a method could not convert a string into a numeric format
	
	try {
		    int num = Integer.parseInt("Five");
		} catch (NumberFormatException e) {
		    e.printStackTrace();
		    System.out.println("A NumberFormatException occurred. Test Execution continues.....");
		} finally {
		    System.out.println("Test Execution completed ! :)");
		}
	...
	try{
		...
		e.printStackTrace();
		System.out.println("This is user-defined exception method. Test Execution continues.....");
	}
